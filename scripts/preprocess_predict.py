...
from qdf.preprocess import load_dict, create_dataset
...
if __name__ == "__main__":
    ...
    print('Preprocess', str(dataset_predict), 'dataset.\n'
          'The preprocessed dataset is saved in', str(dir_predict), 'directory.\n'
          'If the dataset size is large, '
          'it takes a long time and consume storage.\n'
          'Wait for a while...')
    print('-'*50)

    create_dataset(str(dir_predict), 'test',
